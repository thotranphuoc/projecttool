-- get_big_picture: thêm perspective_id, perspective_code, perspective_label
...
BEGIN
  ...
  FROM (
    SELECT jsonb_build_object(
      ...
      'ksf_code',                   ksf.code,
      'ksf_label',                  ksf.label,
      'perspective_id',             o.perspective_id,
      'perspective_code',           p.code,
    ...
    LEFT JOIN ksfs ksf ON ksf.id = o.ksf_id
    LEFT JOIN perspectives p ON p.id = o.perspective_id
  ) sub_obj;
